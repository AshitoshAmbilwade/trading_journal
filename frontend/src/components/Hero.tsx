        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 hover:bg-green-500/20 transition-all cursor-pointer group"
            >
              <Sparkles className="h-4 w-4 text-green-500 group-hover:rotate-12 transition-transform" />
              <span className="text-sm text-green-400">Auto-Sync with 10+ Indian Brokers</span>
              <ChevronRight className="h-3 w-3 text-green-400 group-hover:translate-x-1 transition-transform" />
            </motion.div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                Auto-sync trades from Zerodha, Upstox & 10+ Indian brokers. Backtest strategies, analyze performance, and trade smarter with AI-powered insights.
              </motion.p>
            </div>
            ...
            >
              ...
              <Button size="lg" variant="outline" className="group border-border hover:bg-secondary hover:border-primary/50 transition-all">
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <motion.div
                      ...
                      className="h-8 w-8 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 border-2 border-background"
                    />
                  ))}
                </div>
          ...
          >
            ...
            <motion.div
              ...
              className="hidden lg:block absolute -bottom-6 -left-6 h-32 w-32 rounded-2xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 backdrop-blur-sm"
            />
          </motion.div>
        </div>
      </div>
