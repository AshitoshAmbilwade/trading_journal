...
type Filters = any; // keep loose to match your filters shape
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-6 bg-gray-800/50 rounded-xl border border-gray-700">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setFilters((prev: any) => ({ ...prev, symbol: e.target.value }))}
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setFilters((prev: any) => ({ ...prev, strategy: e.target.value }))}
            className="bg-gray-700 border-gray-600 text-white"
          />
        </div>
          ...
          <div className="flex gap-3">
            <div className="flex-1 flex items-center gap-2">
              <Input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, tradeDateFrom: e.target.value }))}
            ...
            <div className="flex-1 flex items-center gap-2">
              <Input
                ...
                onChange={(e) => setFilters((prev: any) => ({ ...prev, tradeDateTo: e.target.value }))}
                className="bg-gray-700 border-gray-600 text-white flex-1"
              />
              <Button
                type="button"
